...
echo "Running RISC Zero benchmarks | GPU | 1 signature"
...
echo "Running SP1 Hypercube benchmarks | GPU | 10 signatures"
...
echo "Running RISC Zero benchmarks | GPU | 10 signatures"
...
echo "Running SP1 Hypercube benchmarks | GPU | 20 signatures"
...
echo "Running RISC Zero benchmarks | GPU | 20 signatures"
...
echo "Running SP1 Hypercube benchmarks | GPU | 50 signatures"
...
echo "Running RISC Zero benchmarks | GPU | 50 signatures"
...
echo "Running SP1 Hypercube benchmarks | GPU | 100 signatures"
...
echo "Running RISC Zero benchmarks | GPU | 100 signatures"
...
echo "Running SP1 Hypercube benchmarks | GPU | 200 signatures"
...
echo "Running RISC Zero benchmarks | GPU | 200 signatures"
