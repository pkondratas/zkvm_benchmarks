...
RUSTFLAGS="-C target-cpu=native" RUST_LOG=info RISC0_INFO=1 cargo run --release --bin risc0-host -- --n-signatures 20 --max-segment-limit 20 2>&1 | tee -a risc0_20_sig.txt
